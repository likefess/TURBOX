---
Link: Com.Ctrl.Diagram.Connection.@DeleteConnection
---
...
# Поле DeleteConnection

## Описание

    DeleteConnection :Ctrl.Diagram.Item.TItemToolStateTypes;

## Назначение

Управление возможностью удаления соединительного элемента.
