[Options]
Version=7
Query=.Документы.ЧастичнаяЛиквидацияОС_списание,.Документы.ЧастичнаяЛиквидацияОС_продажа
Hierarchical=1
CanHGroupModify=0
CanInsert=0
CanDelete=0
...
Column:7=ГрупповоеОС.Name
Column:8=ГрупповоеОС.КодИмущества
Column:9=Comment
Column:10=Locked
TreeVisible=1
TreeWidth=120
...
Caption=ГрупповоеОС
Hint=@Имущество:ГрупповоеОС=Групповое ОС
Width=143
Lookup=1
ColumnFormat=6
ManualEdit=1

[.Column.ГрупповоеОС.КодИмущества]
Caption=Групповое ОС (код)
Hint=@Имущество:ГрупповоеОСКодИмущества=Групповое ОС (код)
Width=104
